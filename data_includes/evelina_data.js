...
var items = [
    ...
    ["break1", "Message", {html: "To πρώτο μέρος του πειράματος τελείωσε με επιτυχία! Πίεσε το πλήκτρο 1 για να ξεκινήσεις το δεύτερο μέρος. Τα δάχτυλα πρέπει να είναι τοποθετημένα στα πλήκτρα 1, 2 και 3, όπως πριν.", transfer:"keypress"}],
    ["break2", "Message", {html: "To δεύτερο μέρος του πειράματος τελείωσε με επιτυχία! Πίεσε το πλήκτρο 1 για να ξεκινήσεις το τρίτο μέρος. Τα δάχτυλα πρέπει να είναι τοποθετημένα στα πλήκτρα 1, 2 και 3, όπως πριν.", transfer:"keypress"}],
    ["break3", "Message", {html: "To τρίτο μέρος του πειράματος τελείωσε με επιτυχία! Αν θέλεις να κάνεις ένα διάλειμμα, τώρα είναι η ευκαιρία, αλλά μην τα παρατήσεις! Όταν είσαι έτοιμος/η, πίεσε το πλήκτρο 1 για να ξεκινήσεις το τέταρτο μέρος. Τα δάχτυλα πρέπει να είναι τοποθετημένα στα πλήκτρα 1,2 και 3, όπως πριν.", transfer:"keypress"}],
    ["break4", "Message", {html: "To τέταρτο μέρος του πειράματος τελείωσε με επιτυχία! Πίεσε το πλήκτρο 1 για να ξεκινήσεις το προτελευταίο μέρος. Τα δάχτυλα πρέπει να είναι τοποθετημένα στα πλήκτρα 1, 2 και 3, όπως πριν.", transfer:"keypress"}],
    ["break5", "Message", {html: "To προτελευταίο μέρος του πειράματος τελείωσε με επιτυχία! Πίεσε το πλήκτρο 1 για να ξεκινήσεις το τελευταίο μέρος. Τα δάχτυλα πρέπει να είναι τοποθετημένα στα πλήκτρα 1, 2 και 3, όπως πριν.", transfer:"keypress"}],
    ...
    ["T5-filler", "AcceptabilityJudgment", {s: "Η φωνή της ακούετουν πολλά δυνατά."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "H Έλενα εν που το χωρκό του παπά μου."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Ήβραμεν ένα γκρίζο καττούι στον δρόμο."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Εξίασα το βιβλίο μου στο γραφείο."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Η κορούα εχόρεψε με τες φίλες της."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Εστράφηκεν που το ταξίδι ποσταμένη."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Η Σκεύη εφοήθηκεν που τες πουμπουρκές."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Ο Αλέξανδρος επότισεν τα δεντρούθκια."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Eγοράσαμεν όμορφο σπιτούι ένα."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Εφάμεν όρνιθα πατατούες πάλε με."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Eίδα τη προψές μιτσιά κόρη του Αντώνη."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Νικολέττα ήβρεν καλύτερη δουλειά η."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Το άρθρο μας εκδόθηκεν Παρασκευή την."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "O μιτσής έφαεν τα ούλα κεραστικά."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Το στο τραγούδι της ακούστηκεν ράδιο."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Χρυστάλλα η εγόρασεν ένα κινητό."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Πανίκκος έκοψεν ο μερικά λουλούδια."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Στην ο Νικόλας εταξίδεψεν Αγγλία."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Ήβραμεν στην ένα πεζουνούι αυλή μας."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "H τες Αγγελική έκαμεν χαλλουμωτές."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Την Τρίτη επήαμεν ούλοι θέατρο στο."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Έπια μεταχειρισμένο αρμάρι ένα."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Έκοψα τέσσερις που τον τουλίππες κήπο."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Έβαψα το σκαλούι της αυλής άσπρο μας."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Έφα ένα κότσινο το μηλούι πρωί."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Έλυσα ασκήσεις με πολλή προσοχή τες."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Επήαμεν έναν περίπατο πόλη στην."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Με επισκέφτηκεν ανιψιά η μου προχτές."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Οι μαθητές επήαν εκδρομή Πάφο στην."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Νίκος ο πάει θάλασσα κάθε εφτομάν."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Άννα έφαεν θκυο η ελιωτές σήμερα."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Τα θκυο κοπελλούθκια παίζουσιν σαλόνι στο."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Το μωρoύι έπαιζεν παιχνίδι με το του."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "To γραφείο εν μου γεμάτο τετράδια."}],
    ["T5-filler", "AcceptabilityJudgment", {s: "Μαρίνος ο εστράφην έσσω πιττωμένος."}],

    //task 6

    ["T6-C1", "AcceptabilityJudgment", {s: "Πιο πολλά πλάσματα που μένα επήαν στην πρωτεύουσα της Γαλλίας."}],
    ["T6-C1", "AcceptabilityJudgment", {s: "Πιο πολλά πλάσματα που σένα επήαν στα νησιά της Καραϊβικής."}],
    ["T6-C1", "AcceptabilityJudgment", {s: "Πιο πολλές κορούες που τζείνην επήαν κρουαζιέρα στα νησιά Φίτζι."}],
    ["T6-C1", "AcceptabilityJudgment", {s: "Πιο πολλές κορούες που τζείνoν επήαν διακοπές στη Σουηδία."}],
    ["T6-C1", "AcceptabilityJudgment", {s: "Πιο λία πλάσματα που μένα επήαν στα νησιά της Πορτογαλίας."}],

    ["T6-C2", "AcceptabilityJudgment", {s: "Πιο πολλά παιθκιά που μένα ετελειώσαν με καλό βαθμό το λύκειο."}],
    ["T6-C2", "AcceptabilityJudgment", {s: "Πιο πολλά παιθκιά που σένα ετελειώσαν με καλό βαθμό το σχολείο."}],
    ["T6-C2", "AcceptabilityJudgment", {s: "Πιο πολλοί άντρες που τον Παύλο εκάμαν τη θητεία τους στο ναυτικό."}],
    ["T6-C2", "AcceptabilityJudgment", {s: "Πιο πολλοί άντρες που τη Λένα εκάμαν διακοπές στην Αγία Νάπα."}],
    ["T6-C2", "AcceptabilityJudgment", {s: "Πιο λία πλάσματα που μένα ετελειώσαν το λύκειο του Στροβόλου."}],

    ["T6-filler", "AcceptabilityJudgment", {s: "Πιο πολλές φορές επήαμεν στη Γερμανία παρά στη Νορβηγία."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Πιο πολλές φορές τρώμε στη κουζίνα του γραφείου μας παρά έσσω μας."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Πιο πολλές φορές επήαμεν φέτος στο σινεμά παρά στο θέατρο."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Πιο πολλές φορές επήα διακοπές στη θάλασσα παρά στο βουνό."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Πιο πολλά Σάββατα μαειρεύκω με τες φίλες μου παρά μανισιή μου"}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Το κλειδί τζείνων των συρταρκών βρίσκονται πα στο ξύλενο τραπεζούι."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Η κόρη των γειτόνων της Μαρούλλας στέκονται στην αυλή του σχολείου."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "To καττούι των παιθκιών τoυ δασκάλου μας παίζουν ήσυχα στον κήπο τους."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Η φλόγα των τζερκών στα τραπεζούθκια του μπαρ τρεμοπαίζουν στο σκοτάδι."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Η φασαρία που τα τραούθκια των μαθητών ένι σταματούν ποττέ."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Το βιβλίο των παιθκιών της Αγγελικής ένουσιν στη βιβλιοθήκη."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Το πράσινο βαλιτσούι των κορούδων εξεχάστηκαν μες το ταξί."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Το κουτί των ξύλενων μολυφκιών βρίσκονται σε τζείνο το αρμαρούιν."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Οι μιτσιοί που ο Αντρέας εβοήθησε ευχαρίστησεν τους πολλά."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Οι ποδηλάτες που ο οδηγός θωρεί κάθε Τετάρτη σιαιρετά τους."}],
    ["T6-filler", "AcceptabilityJudgment", {s: "Οι μαθητές που ο δάσκαλος απέβαλλε έκαμεν τους παράπονο."}],
