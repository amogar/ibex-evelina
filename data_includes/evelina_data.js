...
var items = [
    ...
    ["break3", "Message", {html: "To τρίτο μέρος του πειράματος τελείωσε με επιτυχία! Αν θέλεις να κάνεις ένα διάλειμμα, τώρα είναι η ευκαιρία! Μετά πίεσε το πλήκρο 1 για να ξεκινήσεις το τέταρτο μέρος", transfer:"keypress"}],
    ["break4", "Message", {html: "To τέταρτο μέρος του πειράματος τελείωσε με επιτυχία! Πίεσε το πλήκρο 1 για να ξεκινήσεις το τέταρτο μέρος", transfer:"keypress"}],
    ["break5", "Message", {html: "To προτελευταίο μέρος του πειράματος τελείωσε με επιτυχία! Πίεσε το πλήκρο 1 για να ξεκινήσεις το τελευταίο μέρος", transfer:"keypress"}],
